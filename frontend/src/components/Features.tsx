        ...
        <section id="features" className="w-full max-w-[1200px] px-6 mx-auto lg:px-8 py-32 z-10">
            ...
            <div className="text-center mb-20 max-w-3xl mx-auto">
                <h2 className="text-4xl md:text-5xl font-black tracking-tight text-slate-900 mb-6">
                    Everything you need to <span className="text-blue-600">verify.</span>
                </h2>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 auto-rows-[300px]">
                ...
                <motion.div
                    ...
                    className="md:col-span-2 relative p-10 bg-white border border-slate-200/60 rounded-[2rem] shadow-[0_8px_30px_rgb(0,0,0,0.04)] overflow-hidden group hover:shadow-xl hover:border-blue-200 transition-all flex flex-col md:flex-row items-center justify-between"
                >
                    <div className="absolute top-0 right-0 w-[400px] h-[400px] bg-gradient-to-br from-blue-100 to-cyan-50 rounded-full blur-3xl -mr-20 -mt-20 opacity-50 group-hover:opacity-100 transition-opacity" />
                    ...
                    <div className="relative z-10 w-full max-w-[280px] h-[200px] flex items-center justify-center">
                        <div className="relative w-40 h-40 flex items-center justify-center">
                            ...
                            <motion.div
                                ...
                                className="absolute inset-0 border-[2px] border-dashed border-blue-200 rounded-full"
                            />
                            {/* Inner dashed ring spinning opposite */}
                            <motion.div
                                animate={{ rotate: -360 }}
                                transition={{ duration: 15, repeat: Infinity, ease: "linear" }}
                                className="absolute inset-6 border border-dashed border-cyan-300 rounded-full"
                            />
                            ...
                            <motion.div
                                ...
                                className="w-14 h-14 bg-gradient-to-tr from-blue-500 to-cyan-400 rounded-full shadow-[0_0_30px_rgba(59,130,246,0.4)] flex items-center justify-center"
                            >
                            ...
                            >
                                <div className="w-4 h-4 bg-white border border-blue-100 rounded-full absolute -top-2 left-1/2 -translate-x-1/2 shadow-lg shadow-blue-200 flex items-center justify-center">
                ...
                <motion.div
                    ...
                    className="md:col-span-1 relative p-8 bg-white border border-slate-200/60 rounded-[2rem] shadow-[0_8px_30px_rgb(0,0,0,0.04)] overflow-hidden group hover:shadow-xl hover:border-purple-200 transition-all"
                >
                    <div className="absolute top-0 right-0 w-[200px] h-[200px] bg-gradient-to-br from-purple-100 to-fuchsia-50 rounded-full blur-2xl -mr-10 -mt-10 opacity-50 group-hover:opacity-100 transition-opacity" />
                    ...
                    <div className="absolute top-6 right-4 lg:right-8 z-0 w-32 h-32 flex items-center justify-center pointer-events-none opacity-80 scale-90 sm:scale-100">
                        <div className="relative w-full h-full max-w-[160px] flex items-center">
                            <svg className="absolute w-full h-full text-purple-200" preserveAspectRatio="none">
                            ...
                            <motion.div
                                ...
                                className="absolute left-[0px] top-[56px] w-4 h-4 bg-purple-500 rounded-full border-2 border-white z-10 shadow-sm"
                            />
                            <motion.div
                            ...
                            <motion.div
                                ...
                                className="absolute left-[120px] top-[56px] w-4 h-4 bg-purple-500 rounded-full border-2 border-white z-10 shadow-sm"
                            />
                            <motion.div
                                animate={{ scale: [1, 1.2, 1] }}
                    ...
                    <div className="relative z-10 flex flex-col h-full justify-between">
                        <div className="w-12 h-12 bg-purple-50 border border-purple-100 rounded-2xl flex items-center justify-center mb-6">
                ...
                >
                    <div className="absolute top-0 right-0 w-[400px] h-[400px] bg-gradient-to-br from-blue-500/20 to-purple-500/20 rounded-full blur-3xl -mr-20 -mt-20 opacity-50 group-hover:opacity-100 transition-opacity" />
                    ...
                    <div className="relative z-10 w-full max-w-[280px] h-[200px] flex items-center justify-center">
                        <div className="relative w-40 h-32">
                            ...
                            <motion.div
                                ...
                                className="absolute top-0 left-1/2 -translate-x-1/2 w-12 h-12 bg-slate-800 border border-slate-600 rounded-xl flex items-center justify-center shadow-lg shadow-blue-500/20 z-10"
                            >
                                <div className="w-4 h-4 rounded-full bg-blue-400 shadow-[0_0_15px_rgba(96,165,250,0.8)] animate-pulse" />
                            </motion.div>
                            ...
                            >
                                <div className="w-3 h-3 rounded-full bg-purple-400 shadow-[0_0_10px_rgba(192,132,252,0.6)]" />
                            </motion.div>
                        </div>
                    </div>
                </motion.div>
