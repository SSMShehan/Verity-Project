                ...
                <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-16">
                    ...
                    <div className="flex flex-col md:col-span-1">
                        <div className="flex items-center space-x-2 mb-4">
                            <div className="w-6 h-6 rounded-md bg-gradient-to-br from-blue-600 to-cyan-500 flex items-center justify-center shadow-sm">
                    ...
                    <div>
                        ...
                        <ul className="space-y-3 text-sm text-slate-500 font-medium">
                            ...
                            <li><a href="#" className="hover:text-blue-600 transition-colors">Community Help</a></li>
                        </ul>
                    </div>
