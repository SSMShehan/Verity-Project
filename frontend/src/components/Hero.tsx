...
const Hero = () => {
    ...
    return (
        <section className="relative flex flex-col items-center justify-center w-full max-w-[1400px] px-6 mx-auto pt-32 pb-20 lg:px-8">
            ...
            >
                <motion.div variants={fadeInUp} className="group cursor-pointer inline-flex items-center space-x-2 px-3 py-1.5 mb-8 rounded-full border border-blue-200/50 bg-blue-50/50 backdrop-blur-md hover:bg-white hover:border-blue-300 transition-all shadow-sm">
                    <span className="flex h-2 w-2">
                        <span className="animate-ping absolute inline-flex h-2 w-2 rounded-full bg-blue-400 opacity-75"></span>
                        <span className="relative inline-flex rounded-full h-2 w-2 bg-blue-500"></span>
                    </span>
                    <span className="text-xs font-semibold tracking-wide text-blue-700">Verity Intelligence Engine 2.0</span>
                ...
                <motion.div variants={fadeInUp} className="flex flex-col sm:flex-row items-center justify-center gap-4 pt-4">
                    <Link to="/register" className="group relative w-full sm:w-auto inline-flex items-center justify-center px-8 py-4 text-base font-bold text-white transition-all duration-300 bg-blue-600 rounded-2xl hover:bg-blue-700 hover:shadow-[0_0_40px_rgba(37,99,235,0.4)] hover:-translate-y-1 overflow-hidden">
                    ...
                    <div className="absolute inset-0 rounded-[2rem] bg-white/60 backdrop-blur-3xl border border-white/80 shadow-[0_20px_60px_-15px_rgba(0,0,0,0.1),0_0_0_1px_rgba(255,255,255,0.5)] overflow-hidden flex flex-col transform-gpu">
                        ...
                        <div className="flex-1 p-8 grid grid-cols-12 gap-6 opacity-90">
                            ...
                            <div className="col-span-9 grid grid-cols-3 gap-6 h-32">
                                <div className="col-span-1 rounded-2xl bg-gradient-to-br from-white to-blue-50/50 border border-white shadow-sm p-6 flex flex-col justify-between">
                                    <div className="flex items-center space-x-2 text-slate-500"><Github className="w-4 h-4 text-blue-600" /><span className="text-sm font-bold">Commits</span></div>
                                ...
                                <div className="col-span-1 rounded-2xl bg-gradient-to-br from-white to-purple-50/50 border border-white shadow-sm p-6 flex flex-col justify-between">
                                    <div className="flex items-center space-x-2 text-slate-500"><Activity className="w-4 h-4 text-purple-600" /><span className="text-sm font-bold">Health Score</span></div>
                                ...
                                <div className="col-span-3 h-full min-h-[160px] rounded-2xl bg-white/80 border border-white shadow-sm p-6 relative overflow-hidden">
                                    ...
                                    <div className="flex items-baseline space-x-2 h-full px-2 w-full justify-between">
                                        ...
                                        {[20, 40, 30, 70, 50, 90, 80, 100, 60].map((h, i) => (
                                            <div key={i} className="w-12 bg-blue-100 rounded-t-lg relative group overflow-hidden" style={{ height: `${h}%` }}>
                                                <div className="absolute bottom-0 w-full bg-blue-500 rounded-t-lg transition-all" style={{ height: `${h * 0.7}%` }}></div>
                                            </div>
                                        ))}
                                    </div>
                                </div>
